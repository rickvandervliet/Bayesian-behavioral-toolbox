...
def main():
    ...
    with pm.Model(coords=coords) as model:           
        ...
        sigma_eta = pm.Gamma('sigma_eta', mu=0.5, sigma=0.25, dims='subjects')
        sigma_epsilon = pm.Gamma('sigma_epsilon', mu=3, sigma=0.5, dims='subjects')
        ...
        idata = pm.sample(cores=4,chains=4,draws=1000,tune=1000,init='adapt_diag')
